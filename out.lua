...
do
    ...
    local function bindDescendants(root, fillColor, outlineColor, fillTransparency)
    ...
    local function tryBindMapStuff()
        ...
        if eventFolder then
            bindDescendants(eventFolder, EVENT_FILL_COLOR, EVENT_OUTLINE_COLOR, EVENT_FILL_TRANSPARENCY)
        end
